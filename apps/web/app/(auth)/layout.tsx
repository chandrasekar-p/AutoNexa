...
import { LoginBrandingProvider } from '@/components/layout/login-branding-context';
  ...
  return (
    <LoginBrandingProvider>
      <div className="relative flex min-h-screen flex-col items-center justify-center gap-6 px-4 py-12">
        ...
        <footer className="relative z-10 max-w-[92vw] rounded-2xl border border-white/10 bg-graphite-900/60 px-4 py-1.5 text-center text-xs text-white shadow-panel backdrop-blur-sm">
