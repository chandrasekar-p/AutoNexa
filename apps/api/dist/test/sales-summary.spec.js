...
const sales_summary_1 = require("../src/modules/reports/sales-summary");
describe('previousPeriodRange', () => {
    it('returns the equal-length window immediately preceding the given range', () => {
        const range = (0, sales_summary_1.previousPeriodRange)(new Date('2026-08-19T00:00:00.000Z'), new Date('2026-08-22T23:59:59.999Z'));
...
describe('computeSalesSummary', () => {
    const entry = (date, amount, vehicleId) => ({
        date: new Date(date),
        amount,
        vehicleId,
    });
    it('buckets by day, sums totals, counts invoices, and dedupes cars serviced within a bucket', () => {
        const current = [
            ...
            entry('2026-08-19T15:00:00.000Z', 600, 'v1'),
            entry('2026-08-20T09:00:00.000Z', 2000, 'v2'),
        ];
        const summary = (0, sales_summary_1.computeSalesSummary)(current, [], 'day');
    ...
    it('returns highestDay: null and zeroed kpis for an empty period, never throwing', () => {
        const summary = (0, sales_summary_1.computeSalesSummary)([], [], 'day');
    ...
    it('computes previousKpis from the previous entries independently of the current bucketing', () => {
        ...
        const summary = (0, sales_summary_1.computeSalesSummary)(current, previous, 'day');
    ...
    it('buckets by month when groupBy is month', () => {
        ...
        const summary = (0, sales_summary_1.computeSalesSummary)(current, [], 'month');
...
//# sourceMappingURL=sales-summary.spec.js.map