...
const reminder_window_1 = require("../src/modules/messaging/reminder-window");
describe('dailyReminderWindow', () => {
    it('returns [tomorrow 00:00 UTC, day-after 00:00 UTC) by default', () => {
        const now = new Date('2026-08-20T08:00:00.000Z');
        const { start, end } = (0, reminder_window_1.dailyReminderWindow)(now);
    ...
    it('respects a custom leadDays', () => {
        const now = new Date('2026-08-20T08:00:00.000Z');
        const { start, end } = (0, reminder_window_1.dailyReminderWindow)(now, 2);
...
//# sourceMappingURL=reminder-window.spec.js.map