...
const estimate_totals_1 = require("../src/modules/estimates/estimate-totals");
describe('calculateLineTotal', () => {
    it('multiplies quantity by unitPrice', () => {
        const total = (0, estimate_totals_1.calculateLineTotal)(2, 499.99);
        expect(total.toString()).toBe('999.98');
    });
    it('rounds a half-cent result to 2 decimal places', () => {
        const total = (0, estimate_totals_1.calculateLineTotal)(1, 10.005);
...
describe('calculateEstimateTotals', () => {
    ...
    it('subtracts discountAmount from the total, never trusting a client-supplied total', () => {
        const totals = (0, estimate_totals_1.calculateEstimateTotals)([{ quantity: 1, unitPrice: 1000, gstRate: 18 }], 100);
...
//# sourceMappingURL=estimate-totals.spec.js.map