...
__decorate([
    (0, permissions_decorator_1.Permissions)('branch:create'),
    (0, common_1.Post)(),
    (0, audit_log_interceptor_1.Audit)('branch.create', 'Branch'),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('branch:read'),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('branch:update'),
    (0, common_1.Patch)(':id'),
    (0, audit_log_interceptor_1.Audit)('branch.update', 'Branch'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('branch:delete'),
    (0, common_1.Delete)(':id'),
    (0, audit_log_interceptor_1.Audit)('branch.delete', 'Branch'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
