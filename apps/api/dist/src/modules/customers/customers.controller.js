...
__decorate([
    (0, permissions_decorator_1.Permissions)('customer:create'),
    (0, common_1.Post)(),
    (0, audit_log_interceptor_1.Audit)('customer.create', 'Customer'),
...
__decorate([
    ...
    (0, common_1.Patch)(':id'),
    (0, audit_log_interceptor_1.Audit)('customer.update', 'Customer'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, audit_log_interceptor_1.Audit)('customer.delete', 'Customer'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
