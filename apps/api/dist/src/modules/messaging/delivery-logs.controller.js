...
const list_delivery_logs_query_dto_1 = require("./dto/list-delivery-logs-query.dto");
const permissions_decorator_1 = require("../../common/decorators/permissions.decorator");
let DeliveryLogsController = class DeliveryLogsController {
    constructor(deliveryLogsService) {
...
__decorate([
    (0, permissions_decorator_1.Permissions)('audit-log:read'),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [list_delivery_logs_query_dto_1.ListDeliveryLogsQueryDto]),
...
exports.DeliveryLogsController = DeliveryLogsController = __decorate([
    ...
    (0, common_1.Controller)('messaging/deliveries'),
