...
__decorate([
    (0, permissions_decorator_1.Permissions)('technician:create'),
    (0, common_1.Post)(),
    (0, audit_log_interceptor_1.Audit)('technician.create', 'Technician'),
...
__decorate([
    (0, permissions_decorator_1.Permissions)('technician:update'),
    (0, common_1.Patch)(':id'),
    (0, audit_log_interceptor_1.Audit)('technician.update', 'Technician'),
    __param(0, (0, common_1.Param)('id')),
